...
const VALUE = new Set(["base", "resume", "model", "effort", "max-turns", "max-budget-usd", "prompt-file", "timeout-ms", "poll-interval-ms", "recent", "status", "purpose", "context", "finalize-at-turn", "review-profile", "task-profile"]);
export function parseArgs(argv) {
  const options = { json: false, wait: false, all: false, global: false, "include-test": false, background: false, write: false, continue: false, fresh: false, base: null, resume: null, model: null, effort: null, "max-turns": null, "max-budget-usd": null, "prompt-file": null, "timeout-ms": null, "poll-interval-ms": null, recent: null, status: null, purpose: null, context: null, "finalize-at-turn": null, "review-profile": null, "task-profile": null, help: false, "enable-review-gate": false, "disable-review-gate": false }, positional = [];
